...
from pylabrobot.backend import HeatShakerBackend
from pylabrobot.Heat_Shaking.backend import HeatShakerBackend
...
class HamiltonHeaterShaker(USBBackend, metaclass=ABCMeta):
  """
